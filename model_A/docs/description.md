...
- Vredet ger taktil feedback och är responsiv och exakt, med fasta steg för varje värde. 
...
- Strömbrytare för att starta och stänga av.
...
- Hjärnan är en ATtiny85/45 och skiftregister används för att skicka data till displayerna.
...
Kostnad: **599kr** Kan även köpas färdigmonterad (+500kr).

Frakt som spårbart paket med Postnord: 59kr

(Kolla även in modell B som istället för sjusegmentdisplayer har en LCD och även visar binära tal, men med lite mindre lödning.) 
