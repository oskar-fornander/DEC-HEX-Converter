...
* Carefully insert the **pre-programmed ATtiny85/45 microcontroller** and the **74HC595 Shift Registers** into its socket. The notch on the IC body must match the notch on the socket and the PCB silkscreen.
...
* Apply hobby glue (or double-sided tape) to the bottom of the **battery box** and glue it securely onto the designated area on the enclosure's **bottom plate**.

### 4. Mount the PCB

* Place the assembled PCB into the main part of the 3D-printed enclosure.
* Use the provided **M3 screws** and **washers** to fasten the PCB securely to the enclosure standoffs. The washers ensure proper screw depth and provide a secure mounting for the PCB.
